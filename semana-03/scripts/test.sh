...
source_dir="$week_dir/elitecommerce/src/main/java/dev/javaelite/catalog"
...
javac --release 21 -d "$build_dir" "$source_dir/Product.java" "$source_dir/Category.java" "$source_dir/Permission.java" "$catalog_source" "$week_dir/elitecommerce/src/test/java/dev/javaelite/catalog/Week3Contract.java"
